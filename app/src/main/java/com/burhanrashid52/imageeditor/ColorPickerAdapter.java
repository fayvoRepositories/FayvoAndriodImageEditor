...
public class ColorPickerAdapter extends RecyclerView.Adapter<ColorPickerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        setColorPickerColors(holder.colorPickerView, colorPickerColors.get(position));
//        holder.colorPickerView.setBackgroundColor(colorPickerColors.get(position));
    }

    private void setColorPickerColors(View colorPickerView, int color){
        Drawable background = colorPickerView.getBackground();
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            colorPickerView.setBackground(background);
        }else{
            colorPickerView.setBackgroundDrawable(background);
        }
    }
    @Override
