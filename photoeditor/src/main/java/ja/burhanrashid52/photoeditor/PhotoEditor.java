...
public interface PhotoEditor {
    ...
    PhotoEditorView getPhotoEditorView();
    ...
    void viewUndo(View view,ViewType viewType);
    ...
    class Builder {
        ...
        MultiTouchListener.DragDeleteListener dragDeleteListener;
        ...
        public Builder(Context context) {
            ...
            drawingView = parentView.getDrawingView();
